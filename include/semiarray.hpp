...
template <class T, std::size_t N> class semiarray : public std::array<T, N> {
  std::size_t _size;
...
public:
  ...
  [[nodiscard]] constexpr auto end() {
    return std::array<T, N>::begin() + _size;
  }
  ...
  [[nodiscard]] constexpr auto rbegin() {
    return std::array<T, N>::rend() - _size;
  }
  [[nodiscard]] constexpr auto rbegin() const {
    return std::array<T, N>::rend() - _size;
  }
  [[nodiscard]] constexpr auto crbegin() const {
    return std::array<T, N>::crend() - _size;
  }
